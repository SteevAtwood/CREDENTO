...
@AnonymousAllowed
@Route(value = "success-contract-requests/:insuranceContractNumber", layout = MainLayout.class)
@Uses(Icon.class)
public class RequestsSuccessContractView extends Div implements BeforeEnterObserver {
    ...
    public RequestsSuccessContractView(RequestService requestService) {
