...
// @Route(value = "master-detail2/:samplePersonID?/:action?(edit)", layout =
// MainLayout.class)
// @RolesAllowed("ADMIN")
// @Uses(Icon.class)
...
// private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE =
// "master-detail2/%s/edit";
...
// .withProperty("icon", important -> important.isImportant() ? "check" :
...
// "Error updating the data. Somebody else has updated the record while you were
// making changes.");
// n.setPosition(Position.MIDDLE);
// n.addThemeVariants(NotificationVariant.LUMO_ERROR);
// } catch (ValidationException validationException) {
// Notification.show("Failed to update the data. Check again that all values are
// valid");
// }
// });
// }
...
// Optional<Long> samplePersonId =
// event.getRouteParameters().get(SAMPLEPERSON_ID).map(Long::parseLong);
// if (samplePersonId.isPresent()) {
// Optional<SamplePerson> samplePersonFromBackend =
// samplePersonService.get(samplePersonId.get());
